import { CreateModel } from "./classes/model.js"
import { CreateShader } from "./classes/shader.js"
...
export async function Engine(){
   ...
   //gl.pixelStorei(gl.UNPACK_FLIP_Y_WEBGL, true);
         ...
         var mouseMove = function(e) {
            ...
            PHI+=dY;
            old_x = e.pageX, old_y = e.pageY;*/
            uniform.iMouse[0] = e.pageX
            uniform.iMouse[1] = e.pageY
            e.preventDefault();
         };
         ...
         var animate = function(time) {
            ...
            uniform.iTime+=dt/1000
            uniform.iTimeDelta = dt/1000
            uniform.iFrameRate=1000/dt
            uniform.iFrame++
            ...
            gl.clear(gl.COLOR_BUFFER_BIT | gl.DEPTH_BUFFER_BIT);
             ...
             model.render(uniform,proj_matrix,view_matrix)
